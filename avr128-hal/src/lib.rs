//! Hardware abstraction layer for the Microchip **AVR128 DB family**
//! (AVR128DB28 / DB48 / DB64).
//!
...
//! (`avr128db28`, `avr128db48`, `avr128db64`). The features are **additive**.
...
//! ([`rtc`]), custom logic ([`ccl`]), op-amps ([`opamp`]) and zero-cross
//! detection ([`zcd`]).
